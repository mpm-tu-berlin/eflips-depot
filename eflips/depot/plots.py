...
ev.vehicle_periods(periods={'depot general': 'darkgray',
                            'park': 'lightgray',
                   ...
                   save=True, show=False, formats=('pdf', 'png',), show_total_power=True,
                   smart_charging=smart_charging, smart_charging_color="forestgreen")
