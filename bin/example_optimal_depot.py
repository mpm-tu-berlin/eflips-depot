...
if __name__ == "__main__":
    ...
    with Session(engine) as session:
        ...
        consumption_results = generate_consumption_result(scenario=scenario)
        ...
        # With this method, the depot generation will prefer line areas
        generate_depot_optimal_size(
            scenario=scenario, delete_existing_depot=True, use_consumption_lut=True
        )
